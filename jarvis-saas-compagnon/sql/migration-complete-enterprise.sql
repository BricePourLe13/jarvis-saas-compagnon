...
-- Transformation du monitoring en solution enterprise-grade
...
-- =============================================
-- 🔒 ÉTAPE 2: RLS POLICIES ENTERPRISE
-- =============================================
...
-- 2.3 Politique SELECT pour admins et système
...
USING (
  ...
  current_setting('request.headers')::json->>'x-api-key' IS NOT NULL
);
...
-- 2.5 Politique DELETE restrictive
...
BEGIN
  ...
  RAISE NOTICE '✅ RLS policies optimisées pour kiosks';
